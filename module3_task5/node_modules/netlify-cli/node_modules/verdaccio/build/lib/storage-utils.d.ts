import { AbbreviatedManifest, Author, Manifest, Package, Version } from '@verdaccio/types';
...
export declare function mergeUplinkTimeIntoLocal(localMetadata: Package, remoteMetadata: Package): any;
export declare function prepareSearchPackage(data: Package, time: unknown): any;
/**
